...
(function(){
    ...
    window.addEventListener("load",async()=>{
        ...
        await loadScript("js/design-order.js?v=3","design-order");
        await loadScript("js/night-design.js?v=3","night-design");
        await loadScript("js/five-new-designs.js?v=6","five-new-designs");
        await loadScript("js/reference-date-order-fix.js?v=4","reference-date-order-fix");
        ...
        await loadScript("js/background-tools-organizer.js?v=3","background-tools-organizer");
        await loadScript("js/footer-background-organizer.js?v=2","footer-background-organizer");
        await loadScript("js/interface-clock.js?v=2","interface-clock");
        ...
        await loadScript("js/adaptive-design-boxes.js?v=1","adaptive-design-boxes");
        ...
        await loadScript("js/compact-design-menu.js?v=2","compact-design-menu");
        ...
        await loadScript("js/carousel-unified-fix.js?v=11","carousel-unified-fix");
