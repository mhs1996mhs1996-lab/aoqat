...
(function(){
  ...
  function initInlinePanels(){
    ...
    style.textContent=`
      ...
      #switchPanel .switch-control-btn{width:100%!important;min-height:34px!important;height:34px!important;margin:4px 0!important;padding:4px 12px!important;border:1px solid #39757a!important;border-radius:9px!important;background:linear-gradient(135deg,#195d65,#247681)!important;color:#fff!important;font-size:13px!important;line-height:1!important;font-weight:700!important;box-shadow:0 2px 5px rgba(0,0,0,.10)!important;cursor:pointer}
      #switchPanel #autoTomorrowToggle{background:#70817f!important;border-color:#859593!important}
      #switchPanel #autoTomorrowToggle.enabled,#switchPanel #autoTomorrowToggle.is-on,#switchPanel #autoTomorrowToggle[aria-pressed="true"],#switchPanel #autoTomorrowToggle[data-enabled="true"]{background:linear-gradient(135deg,#078b46,#10a95b)!important;border-color:#08753e!important;color:#fff!important}
      #switchPanel #showTomorrowNowBtn{background:linear-gradient(135deg,#176f9f,#2588ad)!important;border-color:#3d91af!important}
      #switchPanel #showTodayNowBtn{background:linear-gradient(135deg,#485866,#5e6d78)!important;border-color:#74818a!important}
      .tomorrow-switch-status{margin-top:8px;padding:8px;border-radius:7px;background:rgba(255,255,255,.05);font-size:12px;line-height:1.7;color:#dce6eb}.tomorrow-switch-status.success{border-right:3px solid #23b66d}.tomorrow-switch-status.error{border-right:3px solid #d34d4d}
