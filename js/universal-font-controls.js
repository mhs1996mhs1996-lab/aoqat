...
(function(){
  ...
  function buildColorPalette(){
    ...
    const st=document.createElement('style');st.id='officeLikeColorPaletteStyles';st.textContent='#fontPanel .font-controls{gap:4px!important}#fontPanel .font-controls>label{margin:0!important;line-height:1.25!important}#fontPanel .font-controls select,#fontPanel .font-controls input[type="number"]{min-height:34px!important;height:34px!important;padding-top:3px!important;padding-bottom:3px!important}#fontPanel .font-upload{min-height:34px!important;padding-top:5px!important;padding-bottom:5px!important}#designColorPaletteWrap{margin-top:2px}#designColorPaletteToggle{width:100%;min-height:32px;padding:4px 8px;border:1px solid rgba(255,255,255,.16);border-radius:8px;background:rgba(31,58,75,.9);color:#fff;font:inherit;font-weight:800;display:flex;align-items:center;justify-content:space-between;cursor:pointer}#designColorPaletteToggle .palette-toggle-arrow{font-size:10px;opacity:.8;transition:transform .18s ease}#designColorPaletteWrap.palette-open #designColorPaletteToggle .palette-toggle-arrow{transform:rotate(180deg)}#designColorPalette[hidden]{display:none!important}#designColorPalette{margin-top:3px;padding:5px 8px;border:1px solid rgba(255,255,255,.12);border-radius:9px;background:rgba(3,16,24,.28)}#designColorPalette .palette-title{font-size:12px;font-weight:800;line-height:1.15;margin:0 0 3px}#designColorPalette .theme-base-row{display:grid;grid-template-columns:repeat(10,minmax(20px,1fr));gap:3px;margin-bottom:3px}#designColorPalette .theme-shade-grid:empty{display:none!important;height:0!important;min-height:0!important;margin:0!important;padding:0!important}#designColorPalette .standard-title{margin:0 0 3px!important}#designColorPalette .standard-colors{display:grid;grid-template-columns:repeat(10,minmax(20px,1fr));gap:3px;margin-bottom:3px}#designColorPalette .design-title{margin:0 0 3px!important}#designColorPalette .design-color-swatches{display:flex;flex-wrap:wrap;gap:3px}.palette-color{width:100%;height:25px;min-width:0;padding:0;border:1px solid rgba(255,255,255,.28);border-radius:3px;cursor:pointer}.theme-base-row .palette-color{height:27px}.design-color-swatches .palette-color{width:24px;height:24px;border-radius:4px}.palette-color.selected{outline:2px solid #fff;outline-offset:1px}';document.head.appendChild(st);
