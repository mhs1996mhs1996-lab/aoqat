...
(function(){
  function install(){
    ...
    style.textContent=`
      ...
      body.design-menu-open #designSideMenuBtn{top:7px;right:12px;width:32px;height:32px;border-radius:9px;font-size:18px;box-shadow:0 2px 8px #0003}
      ...
      body.design-menu-open .sidebar{transform:translateX(0)!important;padding-top:66px!important}
