...
(function(){
  function install(){
    ...
    style.textContent=`
      ...
      body.design-menu-open #designSideMenuBtn{top:7px;right:10px;width:27px;height:27px;border-radius:7px;font-size:15px;box-shadow:0 2px 6px #0003}
      ...
      .sidebar{position:fixed!important;top:0!important;right:0!important;bottom:auto!important;z-index:10010!important;width:min(78vw,330px)!important;max-width:330px!important;height:auto!important;max-height:calc(100dvh - 8px)!important;overflow-y:auto!important;overscroll-behavior:contain;background:#f5f6f7!important;padding:62px 8px 18px!important;margin:0!important;box-sizing:border-box!important;transform:translateX(105%)!important;transition:transform .24s ease!important;box-shadow:-8px 0 24px #0003!important}
      body.design-menu-open .sidebar{transform:translateX(0)!important;padding:5px 7px!important}
      body.design-menu-open{overflow:hidden!important}
      body.design-menu-open .sidebar .main-panel{margin-top:31px!important;margin-bottom:1px!important;padding:3px 5px!important}
      body.design-menu-open .sidebar .main-panel h1,body.design-menu-open .sidebar .main-panel h2,body.design-menu-open .sidebar .main-panel h3{margin-top:0!important;margin-bottom:2px!important;line-height:1!important}
      body.design-menu-open .sidebar .panel{margin-top:1px!important;margin-bottom:1px!important}
      body.design-menu-open .sidebar .section-title,body.design-menu-open .sidebar .accordion-header{min-height:31px!important;padding-top:2px!important;padding-bottom:2px!important}
      body.design-menu-open .sidebar .compact-design-row,body.design-menu-open .sidebar .compact-menu-row{min-height:31px!important;padding-top:2px!important;padding-bottom:2px!important;margin-top:1px!important;margin-bottom:1px!important}
      ...
      @media(max-width:420px){.sidebar{width:78vw!important;max-width:330px!important}}
      @media(min-width:801px){#designSideMenuBtn{top:12px;right:12px}body.design-menu-open #designSideMenuBtn{top:7px;right:10px}}
    `;
