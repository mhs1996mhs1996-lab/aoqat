...
(function(){
  function install(){
    ...
    style.textContent=`
      ...
      body.design-menu-open #designSideMenuBtn{top:8px;right:10px;width:28px;height:28px;border-radius:7px;font-size:16px;box-shadow:0 2px 6px #0003}
      ...
      .sidebar{position:fixed!important;top:0!important;right:0!important;bottom:auto!important;z-index:10010!important;width:min(72vw,310px)!important;max-width:310px!important;height:auto!important;max-height:calc(100dvh - 8px)!important;overflow-y:auto!important;overscroll-behavior:contain;background:#f5f6f7!important;padding:62px 8px 18px!important;margin:0!important;box-sizing:border-box!important;transform:translateX(105%)!important;transition:transform .24s ease!important;box-shadow:-8px 0 24px #0003!important}
      body.design-menu-open .sidebar{transform:translateX(0)!important;padding:6px 7px!important}
      body.design-menu-open{overflow:hidden!important}
      body.design-menu-open .sidebar .main-panel{margin-top:34px!important;margin-bottom:2px!important;padding:5px 6px!important}
      ...
      @media(max-width:420px){.sidebar{width:72vw!important;max-width:310px!important}}
      @media(min-width:801px){#designSideMenuBtn{top:12px;right:12px}body.design-menu-open #designSideMenuBtn{top:8px;right:10px}}
    `;
