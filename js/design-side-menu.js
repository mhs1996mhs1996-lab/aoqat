...
(function(){
  function install(){
    ...
    style.textContent=`
      #designSideMenuBtn{position:fixed;top:92px;right:10px;z-index:10020;width:40px;height:40px;border:0;border-radius:10px;background:#173d35;color:#fff;font-size:25px;line-height:1;display:flex;align-items:center;justify-content:center;box-shadow:0 3px 12px #0003;cursor:pointer}
      ...
      @media(max-width:800px){.workspace{padding-top:48px!important}}
      @media(min-width:801px){#designSideMenuBtn{top:92px;right:12px}}
    `;
