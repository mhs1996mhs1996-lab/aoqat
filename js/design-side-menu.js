...
(function(){
  function install(){
    ...
    style.textContent=`
      #designSideMenuBtn{position:fixed;top:11px;right:12px;z-index:10020;width:31px;height:31px;border:1px solid rgba(255,255,255,.16);border-radius:8px;background:linear-gradient(145deg,#1b5147,#123c35);color:transparent;font-size:0;line-height:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2.5px;box-shadow:0 2px 8px #0003;cursor:pointer;padding:0}#designSideMenuBtn .menu-bar{display:block;width:13px;height:1.4px;border-radius:999px;background:#fff;box-shadow:0 0 2px rgba(255,255,255,.2);transition:transform .2s ease,opacity .2s ease}
      ...
      .drag-info{display:none!important}body.design-menu-open .preview-header{display:none!important;height:0!important;min-height:0!important;margin:0!important;padding:0!important;border:0!important;background:none!important}body.design-menu-open .previewBox::before,body.design-menu-open .previewBox::after,body.design-menu-open .workspace::before,body.design-menu-open .workspace::after{display:none!important;content:none!important}
      ...
      body.design-menu-open .sidebar .main-panel>.inline-control-panel:not(.inline-open){display:none!important;margin:0!important;padding:0!important;border:0!important;min-height:0!important;height:0!important;box-shadow:none!important}body.design-menu-open .sidebar .main-panel>.inline-control-panel:empty{display:none!important}body.design-menu-open .sidebar .main-panel::after{display:none!important;content:none!important}body.design-menu-open .sidebar .main-panel>*:last-child:not(#topExportJpg):not(.main-action):not(#backgroundFontGroup):not(#datePrayerGroup){display:none!important}
