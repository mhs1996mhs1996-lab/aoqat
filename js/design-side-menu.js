...
(function(){
  function install(){
    ...
    style.textContent=`
      ...
      body.design-menu-open .sidebar{transform:translateX(0)!important;padding:8px 10px 8px!important}
      body.design-menu-open{overflow:hidden!important}
      body.design-menu-open .sidebar .main-panel{margin-top:38px!important;margin-bottom:4px!important;padding-top:8px!important;padding-bottom:8px!important}
      body.design-menu-open .sidebar .main-panel h1,body.design-menu-open .sidebar .main-panel h2,body.design-menu-open .sidebar .main-panel h3{margin-top:0!important;margin-bottom:6px!important;line-height:1.15!important}
      body.design-menu-open .sidebar .panel{margin-top:3px!important;margin-bottom:3px!important}
      body.design-menu-open .sidebar .section-title,body.design-menu-open .sidebar .accordion-header{min-height:40px!important;padding-top:6px!important;padding-bottom:6px!important}
