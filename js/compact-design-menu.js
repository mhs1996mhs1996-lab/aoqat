...
(function(){
  ...
  function addStyles(){
    ...
    s.textContent=`
      ...
      .visibility-section-toggle{width:100%!important;min-height:38px!important;height:38px!important;margin:0!important;padding:5px 11px!important;border:1px solid rgba(255,255,255,.20)!important;border-radius:9px!important;color:#fff!important;font-weight:800!important;font-size:13.5px!important;display:flex!important;align-items:center!important;justify-content:space-between!important;gap:8px!important;cursor:pointer!important;box-shadow:0 2px 7px rgba(20,45,55,.12)!important}
      #designEditTools .visibility-section-toggle{background:linear-gradient(135deg,#176c78,#238b88)!important;border-color:#2d8f91!important}
      #interfaceVisibilityControls .visibility-section-toggle{background:linear-gradient(135deg,#315f7a,#3d7890)!important;border-color:#548ba0!important}
      #designVisibilityControls .visibility-section-toggle{background:linear-gradient(135deg,#65557d,#806a96)!important;border-color:#8b79a0!important}
      .visibility-section-toggle span{color:#fff!important}.visibility-section-toggle .visibility-arrow{font-size:10px!important;opacity:.9;transition:transform .18s ease}.visibility-section-toggle[aria-expanded="true"] .visibility-arrow{transform:rotate(180deg)}
