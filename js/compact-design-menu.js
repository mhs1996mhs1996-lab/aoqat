...
(function(){
  ...
  function addStyles(){
    ...
    s.textContent=`
      ...
      #backgroundFontGroup>#backgroundFontMainBtn{background:linear-gradient(135deg,#7b3fa1,#a55bc1)!important;border:1px solid #bd78d1!important;box-shadow:0 3px 10px rgba(101,48,126,.28)!important}
      #datePrayerGroup>#datePrayerMainBtn{background:linear-gradient(135deg,#0d7890,#13a2a0)!important;border:1px solid #39b8b0!important;box-shadow:0 3px 10px rgba(7,105,119,.28)!important}
      ...
      #backgroundFontSubmenu>.main-action{background:linear-gradient(135deg,#704092,#8e55aa)!important;border:1px solid #a86cbe!important;color:#fff!important}
      #datePrayerSubmenu>.main-action{background:linear-gradient(135deg,#126b80,#168f91)!important;border:1px solid #35a7a4!important;color:#fff!important}
