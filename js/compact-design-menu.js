...
(function(){
  ...
  function addStyles(){
    ...
    s.textContent=`
      ...
      /* القوائم الداخلية تظهر كنافذة منبثقة، مع إبقاء نفس الأزرار والمحتوى */
      #datePrayerSubmenu,#backgroundFontSubmenu{display:none!important;position:fixed!important;z-index:10040!important;top:50%!important;left:50%!important;right:auto!important;transform:translate(-50%,-50%)!important;width:max-content!important;min-width:210px!important;max-width:calc(100vw - 28px)!important;padding:10px!important;margin:0!important;border:1px solid rgba(255,255,255,.18)!important;border-radius:12px!important;background:rgba(5,20,30,.97)!important;box-shadow:0 14px 38px rgba(0,0,0,.45)!important}
      #datePrayerGroup.group-open>#datePrayerSubmenu,#backgroundFontGroup.group-open>#backgroundFontSubmenu{display:block!important}
      #datePrayerSubmenu>.main-action,#backgroundFontSubmenu>.main-action{width:100%!important;max-width:100%!important;min-width:0!important;min-height:34px!important;height:34px!important;margin:0 0 5px!important;padding:5px 9px!important;border-radius:7px!important;font-size:11.5px!important;display:flex!important;align-items:center!important;justify-content:flex-start!important;gap:6px!important;box-shadow:none!important;white-space:nowrap!important}
